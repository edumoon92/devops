...
Suite Setup       Run Keywords    Open Browser To Start Page    Go To Page "links.html"
...
Capture page screenshot to default location
    [Documentation]    LOG 1:4 </td></tr><tr><td colspan="3"><a href="selenium-screenshot-1.png"><img src="selenium-screenshot-1.png" width="800px"></a>
...
Capture page screenshot computed name is unique
    [Setup]    Run Keywords    Remove files    ${OUTPUTDIR}/unique-screenshot-*.png
    ...    AND    Touch    ${OUTPUTDIR}/unique-screenshot-1.png
    ...    AND    Touch    ${OUTPUTDIR}/unique-screenshot-2.png
    ...    AND    Touch    ${OUTPUTDIR}/unique-screenshot-4.png    # unique-screenshot-3 is purposely left out
    ...
    Should be equal    ${actual}    ${expected}    values=False    msg=Expected screenshot to be named '${expected}' but it was '${actual}'
...
Capture page screenshot advanced formatting name is unique
    [Setup]    Run Keywords    Remove files    ${OUTPUTDIR}/advanced-screenshot-*.png
    ...    AND    Touch    ${OUTPUTDIR}/advanced-screenshot-002.png
    ...    AND    Touch    ${OUTPUTDIR}/advanced-screenshot-003.png
    ...    AND    Touch    ${OUTPUTDIR}/advanced-screenshot-005.png    # advanced-screenshot-4 is purposely left out
...
Capture page screenshot explicit name will overwrite
    [Setup]    Run Keywords    Remove files    ${OUTPUTDIR}/explicit-screenshot-*.png
    ...
    Should be equal as numbers    ${count}    1    values=False    msg=Expected to find one screenshot file, found ${count}
