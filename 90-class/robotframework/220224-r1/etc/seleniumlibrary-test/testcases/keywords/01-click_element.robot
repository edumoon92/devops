...
Suite Setup       Run Keywords    Open Browser To Start Page    Go To Page "javascript/click.html"
...
Click Element Action Chain
    [Documentation]    LOB 1:1 INFO Clicking 'singleClickButton' using an action chain.
