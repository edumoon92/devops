...
Title Should Be
    ...
    Run Keyword And Expect Error    Page title was not expected    Title Should Be    not a title    message=Page title was not expected
...
Element Should Contain
    ...
    Run Keyword And Expect Error    Element with locator 'missing_id' not found.    Element Should Contain    missing_id    This should report missing element.
    Run Keyword And Expect Error    Element 'some_id' should have contained text 'THIS TEXT' but its text was 'This text is inside an identified element'.    Element Should Contain    some_id    THIS TEXT    ignore_case=False
    Run Keyword And Expect Error    Element 'some_id' should have contained text 'foobar' but its text was 'This text is inside an identified element'.    Element Should Contain    some_id    foobar    ignore_case=True
...
Element Should Not Contain
    ...
    Run Keyword And Expect Error    Element 'some_id' should not contain text 'TEXT' but it did.    Element Should Not Contain    some_id    TEXT    ignore_case=True
    Run Keyword And Expect Error    Element 'some_id' should not contain text 'text' but it did.    Element Should Not Contain    some_id    text    ignore_case=False
    Run Keyword And Expect Error    Element with locator 'missing_id' not found.    Element Should Not Contain    missing_id    This should report missing element.
...
Element Text Should Be
    ...
    Run Keyword And Expect Error    The text of element 'some_id' should have been 'inside' but it was 'This text is inside an identified element'.    Element Text Should Be    some_id    inside
...
Element Text Should Not Be
    ...
    Run Keyword And Expect Error    The text of element 'some_id' was not supposed to be 'This text is inside an identified element'.    Element Text Should Not Be    some_id    This text is inside an identified element
    Run Keyword And Expect Error    The text of element 'some_id' was not supposed to be 'This text is inside an identified element'.    Element Text Should Not Be    some_id    This text is inside an identified element    ignore_case=False
    Run Keyword And Expect Error    The text of element 'some_id' was not supposed to be 'THIS TEXT is inside an identified element'.    Element Text Should Not Be    some_id    THIS TEXT is inside an identified element    ignore_case=True

Get Text
    ${str} =    Get Text    some_id
    Should Match    ${str}    This text is inside an identified element
    Run Keyword And Expect Error    Element with locator 'missing_id' not found.    Get Text    missing_id
...
TextArea Should Contain
    ...
    Run Keyword And Expect Error    Text area 'comment' should have contained text 'Hello World!' but it had 'This is a comment.'.    TextArea Should Contain    comment    Hello World!

TextArea Value Should Be
    [Setup]    Go To Page "forms/email_form.html"
    TextArea Value Should Be    comment    ${EMPTY}
    Input Text    comment    This is a comment.
    Run Keyword And Expect Error    Text area 'comment' should have had text 'Hello World!' but it had 'This is a comment.'.    TextArea Value Should Be    comment    Hello World!
