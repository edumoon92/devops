...
Wait Until Element Is Visible
    ...
    Run Keyword And Expect Error    Element 'hidden' not visible after 10 milliseconds.    Wait Until Element Is Visible    hidden    0.01
    Run Keyword And Expect Error    User error message    Wait Until Element Is Visible    hidden    0.01    User error message
    Wait Until Element Is Visible    hidden    2 s
    Run Keyword And Expect Error    Element 'invalid' not visible after 100 milliseconds.    Wait Until Element Is Visible    invalid    0.1
