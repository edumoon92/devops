*** Settings ***
Suite Setup       Run Keywords    Open Browser To Start Page    Go To Page "javascript/click_modifier.html"
...
Click Element Wrong Modifier
    Run Keyword And Expect Error    ValueError: 'FOOBAR' modifier does not match to Selenium Keys    Click Element    Button    Foobar
