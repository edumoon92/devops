...
List Selection Should Be
    [Documentation]    LOG 1 Verifying list 'interests' has options [${SPACE*2}] selected.
    ...
    Run Keyword And Expect Error    List 'possible_channels' should have had selection ? Email | Telephone | Direct mail ? but selection was ? Email (email) | Telephone (phone) ?.    List Selection Should Be    possible_channels    Email    Telephone    Direct mail

List Selection Should Be When Extraneous Options Are Selected
    Run Keyword And Expect Error    List 'possible_channels' should have had selection ? email ? but selection was ? Email (email) | Telephone (phone) ?.    List Selection Should Be    possible_channels    email
...
Unselect works only for multiselect lists
    Run Keyword And Expect Error    Un-selecting options works only with multi-selection lists.    Unselect From List By Label    preferred_channel    Email
    Run Keyword And Expect Error    Un-selecting options works only with multi-selection lists.    Unselect From List By Value    preferred_channel    Email
...
Select Non-Existing Item From Single Selection List
    Run Keyword And Expect Error    NoSuchElementException: Message: Cannot locate option with value: not_there?    Select From List By Value    preferred_channel    not_there    no_way_there
...
Select Non-Existing Item From Multi-Selection List
    Run Keyword And Expect Error    NoSuchElementException: Message: Cannot locate option with value: TinCanPhone?    Select From List By value    possible_channels    TinCanPhone    SmokeSignals
    Run Keyword And Expect Error    NoSuchElementException: Message: Could not locate element with visible text: Tin Can Phone?    Select From List By Label    possible_channels    Tin Can Phone    Email    Smoke Signals

Unselect Non-Existing Item From List
    Run Keyword And Expect Error    NoSuchElementException: Message: Could not locate element with value: Tin Can Phone?    Unselect From List By Value    possible_channels    Tin Can Phone    Smoke Signals
    Run Keyword And Expect Error    NoSuchElementException: Message: Could not locate element with visible text: Tin Can Phone?    Unselect From List By Label    possible_channels    Tin Can Phone    Smoke Signals    Email
...
Select All From List
    ...
    Run Keyword And Expect Error    'Select All From List' works only with multi-selection lists.    Select All From List    preferred_channel

List Should Have No Selections
    [Documentation]    LOG 1 Verifying list 'interests' has no selections.
    List Should Have No Selections    interests
    Select All From List    interests
    Run Keyword And Expect Error    List 'interests' should have had no selection but selection was ? Males (males) | Females (females) | Others (others) ?.    List Should Have No Selections    interests
