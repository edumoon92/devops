*** Settings ***
Suite Setup       Run Keywords    Open Browser To Start Page    Go To Page "forms/prefilled_email_form.html"
...
*** Keywords ***
Open Browser To "forms/prefilled_email_form.html"
    ${index} =    Open Browser    ${FRONT PAGE}    ${BROWSER}    remote_url=${REMOTE_URL}    desired_capabilities=${DESIRED_CAPABILITIES}
