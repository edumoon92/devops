*** Settings ***
Suite Setup       Run Keywords    Open Browser To Start Page    Go To Front Page    Set Info Loglevel
Suite Teardown    Run Keywords    Set Debug Loglevel    Close All Browsers
...
Disable Run on Failure With Nothing
    [Documentation]    LOG 1 No keyword will be run on failure.
    ...    LOG 2.1:2 NONE
