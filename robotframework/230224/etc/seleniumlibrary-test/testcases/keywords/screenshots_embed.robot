...
Capture Page Screenshot Embedded By Screenshot Root Directory
    [Documentation]    LOG 2:4 INFO STARTS: </td></tr><tr><td colspan="3"><img alt="screenshot" class="robot-seleniumlibrary-screenshot" src="data:image/png;base64,
    [Tags]    NoGrid
...
Capture Element Screenshot EMBED As File Name
    [Documentation]    LOG 3:7 INFO STARTS: </td></tr><tr><td colspan="3"><img alt="screenshot" class="robot-seleniumlibrary-screenshot" src="data:image/png;base64,
    [Tags]    NoGrid
    [Setup]    Remove .png Files
