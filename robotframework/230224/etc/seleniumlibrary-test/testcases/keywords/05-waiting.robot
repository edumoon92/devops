...
Wait For Condition requires `return`
    Run Keyword And Expect Error    ValueError: Condition 'window.document.title == "Changed"' did not have mandatory 'return'.    Wait For Condition    window.document.title == "Changed"
...
Wait Until Page Contains Element
    ...
    Run Keyword And Expect Error    Element 'id:ääööåå' did not appear in 100 milliseconds.    Wait Until Page Contains Element    id:ääööåå    0.1 seconds

Wait Until Page Contains Element Limit No Elements
    Run Keyword And Expect Error    Page should have contained "5" %cnon-existent element(s) within 100 milliseconds.    Wait Until Page Contains Element    %cnon-existent    0.1 seconds    limit=5

Wait Until Page Contains Element Limit Too Few Elements
    Run Keyword And Expect Error    Page should have contained "10" //div element(s) within 100 milliseconds.    Wait Until Page Contains Element    //div    0.1 seconds    limit=10

Wait Until Page Contains Element Limit Too Many Elements
    Run Keyword And Expect Error    Page should have contained "1" //div element(s) within 100 milliseconds.    Wait Until Page Contains Element    //div    0.1 seconds    limit=1
...
Wait Until Page Contains Element Limit With Negative Limit
    Run Keyword And Expect Error    Page should have contained "-1" //divNotExists element(s) within 100 milliseconds.    Wait Until Page Contains Element    //divNotExists    0.1 seconds    limit=-1
...
Wait Until Page Does Not Contain Element
    ...
    Run Keyword And Expect Error    Custom Error ää ÖÖ    Wait Until Page Does Not Contain Element    content    0.1 seconds    Custom Error ää ÖÖ
...
Wait Until Page Does Not Contain Element Limit Found
    Run Keyword And Expect Error    Page should have not contained "5" //div element(s) within 100 milliseconds.    Wait Until Page Does Not Contain Element    //div    0.1 seconds    limit=5
...
Wait Until Element Is Enabled
    Run Keyword And Expect Error    Element 'id=disabled' was not enabled in 2 milliseconds.    Wait Until Element Is Enabled    id=disabled    2ms
    Run Keyword And Expect Error    User error message    Wait Until Element Is Enabled    id=disabled    0.003    User error message
    Wait Until Element Is Enabled    id=disabled    2 s
    Run Keyword And Expect Error    Element with locator 'id=invalid' not found.    Wait Until Element Is Enabled    id=invalid    0.1

Wait Until Element Is Enabled with readonly element
    Run Keyword And Expect Error    Element 'readonly' was not enabled in 2 milliseconds.    Wait Until Element Is Enabled    readonly    2ms
    Wait Until Element Is Enabled    readonly    2 s

Wait Until Element Contains
    Run Keyword And Expect Error    Element 'id=content' did not get text 'New' in 1 millisecond.    Wait Until Element Contains    id=content    New    0.001
    Run Keyword And Expect Error    User error message    Wait Until Element Contains    id=content    New    99ms    User error message
...
Wait Until Element Does Not Contain
    Run Keyword And Expect Error    Element 'id=content' still had text 'This is' after 100 milliseconds.    Wait Until Element Does Not Contain    id=content    This is    0.1
...
Timeout can be zero
    Run Keyword And Expect Error    Element 'content' did not get text 'New Content' in 0 seconds.    Wait Until Element Contains    content    New Content    0
    Run Keyword And Expect Error    Element 'content' did not get text 'New Content' in 0 seconds.    Wait Until Element Contains    content    New Content    ${0}
