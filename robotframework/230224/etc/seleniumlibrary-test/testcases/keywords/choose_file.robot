...
Choose File And File Does Not Exist
    ...
    Run Keyword And Expect Error    InvalidArgumentException: Message:*    Choose File    file_to_upload    ${CURDIR}${/}NotHere.txt
...
Choose File With Grid
    [Documentation]    LOG 1:6 DEBUG GLOB: POST*/session/*/file*"file": "*
    [Tags]    OnlyGrid
...
Choose File With Grid From Library Using SL choose_file method
    [Documentation]    LOG 3:6 DEBUG GLOB: POST*/session/*/file*"file": "*
    [Tags]    OnlyGrid
    [Setup]    Go To Page "forms/file_upload_form.html"
...
Input Text Should Work Same Way When Not Using Grid
    [Documentation]    LOG 1:5 DEBUG GLOB: POST*/session/*/clear {"*
