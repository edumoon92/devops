...
Suite Setup       Run Keywords    Open Browser To Start Page    Go To Page "cookies.html"
...
Non-existent Cookie
    Run Keyword And Expect Error    Cookie with name 'missing' not found.    Get Cookie    missing
...
Test Get Cookie Keyword Logging
    [Documentation]    LOG 1:4 ${cookie} = name=another
    ...    value=value
    ...    path=/
    ...    domain=localhost
    ...    secure=False
